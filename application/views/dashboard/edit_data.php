		    ...
		    <div class="main-panel" id="main-panel">
		        ...
		        <div class="panel-header">
		            <div class="header text-center">
		                <h2 class="title">Form Edit Data Pembelian</h2>
		                <p class="category">
		                    Form ini digunakan untuk melakukan perubahan pada data pembelian.
		                </p>
		            </div>
		        </div>
		        <div class="content">
		                            ...
		                            <form method="POST" action="">
		                                ...
		                                <div class="row">
		                                    <div class="col-md-11 pr-2 ml-5">
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" id="customer" name="customer" placeholder="Isi nama lengkap pembeli." value="<?= $tp['customer'] ?>" />
		                                ...
		                                <div class="row">
		                                    <div class="col-md-11 pr-2 ml-5">
		                                        <div class="form-group">
		                                            <label>Mobil</label>
		                                            <input type="text" class="form-control" id="car" name="car" placeholder="Isi nama mobil yang dibeli." value="<?= $tp['car'] ?>" />
		                                ...
		                                <div class="row">
		                                    <div class="col-md-11 pr-2 ml-5">
		                                        <div class="form-group">
		                                            ...
		                                            <input type="date" class="form-control" id="date" name="date" placeholder="Isi dengan tanggal pembelian mobil." value="<?= $tp['date'] ?>" />
		                                ...
		                                <div class="row">
		                                    <div class="col-md-11 pr-2 ml-5">
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" id="total" name="total" placeholder="Isi dengan diawali jumlah yang telah dibayarkan." value="<?= $tp['total'] ?>" />
		                                ...
		                                <div class="row">
		                                    <div class="col-md-11 pr-2 ml-5">
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" id="status" name="status" placeholder="Isi dengan status Lunas / Belum Lunas." value="<?= $tp['status'] ?>" />
